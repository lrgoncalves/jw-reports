...
class RegularPioneerController extends PioneerController
{
    use DateTrait;
    ...
    public function index()
    {
        return view('pioneer/index', [
            'ajaxDataRoute' => route('regular_pioneer.ajaxData')
        ]);
    }

    public function ajaxData() 
    {
        $builder = PublisherServiceType::where('service_type_id', 4)
