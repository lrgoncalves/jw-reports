<html>
    <head>
        <title>Relatório de campo da congregação </title>
    ...
    @foreach ($data as $d)
        ...
        <table class="data">
            ...
            <tr>
                <td colspan="7">
                    <span>Nome:</span> {{ $d['name'] }}
                </td>
            </tr>
            <tr>
                <td colspan="5">
                    <span>Data de nascimento:</span> {{ $d['birthdate'] }}
                </td>
                <td>
                    <span>[ {{ ($d['gender'] == 'M' ? 'x' : ' ') }} ] Masculino</span>
                </td>
                <td>
                    <span>[ {{ ($d['gender'] == 'F' ? 'x' : ' ') }} ] Feminino</span>
                </td>
            </tr>
            <tr>
                <td colspan="5">
                ...
                <td>
                    <span>[ {{ (!$d['anointed'] ? 'x' : ' ') }} ] Outras ovelhas</span>
                </td>
                <td>
                    <span>[ {{ ($d['anointed'] ? 'x' : ' ') }} ] Ungido</span>
                </td>
            </tr>
            <tr>
                <td colspan="7">
                    <div class='right'>
                        <span>[ {{ ($d['privilege'] == 'OM' ? 'x' : ' ') }} ] Ancião</span>
                        &nbsp;
                        <span>[ {{ ($d['privilege'] == 'MS' ? 'x' : ' ') }} ] Servo ministerial</span>
                        &nbsp;
                        <span>[ {{ ($d['regular_pioneer'] ? 'x' : ' ') }} ] Pioneiro regular</span>
                    </div>
                </td>
            </tr>
