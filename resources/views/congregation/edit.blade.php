                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form method="post" action="{{ $action }}">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    {{-- <button type="reset" class="btn btn-lg btn-block btn-info" onclick="javascript: window.location='/voltar'">{{ ($disabled) ? 'Voltar' : 'Cancelar' }}</button>                                    --}}
                                    <button type="reset" class="btn btn-lg btn-block btn-info" id="btnVoltar">{{ ($disabled) ? 'Voltar' : 'Cancelar' }}</button>
                                </div>
