                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input name="name" type="text" class="form-control" placeholder="" value="{{ $group->name }}" required
                                            {{ ($disabled) ? 'disabled' : '' }}>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control publisherSelect" id="publisherSelect" name="overseer_id" required>
                                            <option value="">Selecione</option>
                                            @foreach ($publishers as $item)
                                                <option value="{{ $item->id }}"
                                                {{ (($group->overseer_id == $item->id)) ? 'selected' : ''}}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control publisherSelect" id="publisherSelect" name="assistant_id" required>
                                            <option value="">Selecione</option>                                        
                                            @foreach ($publishers as $item)
                                                <option value="{{ $item->id }}"
                                                {{ (($group->assistant_id == $item->id)) ? 'selected' : ''}}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
